...
# AWS Workload Account Role Setup

This repo contains a Terraform module that is part of the tooling to provision access for users (developers/operators) to a project team's accounts within an AWS Landing Zone.
